...
def main():
    ...
    # for i in range(9):
    #     plt.subplot(3, 3, i+1)
    #     plt.plot(traningSet[:,i],alpha=0.7,label='original')
    #     plt.legend()
    #     plt.plot(trend[:, i],alpha=0.7,label='Trend')
    #     plt.legend()
    #     plt.title(column[i])
    #
    #
    ...
    # for i in range(9):
    #     plt.subplot(3, 3, i+1)
    #     plt.plot(seasonal[:, i], label='seasonal')
    #     plt.legend()
    #     plt.title(column[i])
    # plt.show()
    ...
    for i in range(10):
        ...
        plt.plot(traningSet[:,i],'brown')
        plt.plot(trend[:,i],'grey')
        plt.title(column[i])
